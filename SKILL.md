...
6. Merge, selectively enrich, then let AI write the report directly from the data.
7. Generate HTML, PDF, or email only after the markdown report is editorially complete.
...
- For hard constraints on AI report generation, read [report-generation-spec.md](/d:/Projects/fin-pol-gov-news/references/report-generation-spec.md).
